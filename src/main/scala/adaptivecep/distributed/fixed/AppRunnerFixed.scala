...
object AppRunnerFixed extends App {
  ...
  */
  ...
  val address2 = Address("akka.tcp", "ClusterSystem", "18.222.209.165", 8000)
  val address3 = Address("akka.tcp", "ClusterSystem", "18.191.99.176", 8000)
  val address4 = Address("akka.tcp", "ClusterSystem", "18.222.222.247", 8000)
  val address5 = Address("akka.tcp", "ClusterSystem", "13.58.254.247", 8000)
  val address6 = Address("akka.tcp", "ClusterSystem", "18.216.120.43", 8000)
  val address7 = Address("akka.tcp", "ClusterSystem", "18.218.96.224", 8000)
  val address8 = Address("akka.tcp", "ClusterSystem", "18.220.117.46", 8000)
  val address9 = Address("akka.tcp", "ClusterSystem", "18.217.113.151", 8000)
  val address10 = Address("akka.tcp", "ClusterSystem", "18.222.176.55", 8000)
  val address11 = Address("akka.tcp", "ClusterSystem", "18.217.59.29", 8000)
