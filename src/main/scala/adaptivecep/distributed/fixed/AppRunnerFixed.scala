...
object AppRunnerFixed extends App {
  ...
  */
  val globalIP: String = "176.199.210.16"

  val address1 = Address("akka.tcp", "ClusterSystem", globalIP, 2551)
  val address2 = Address("akka.tcp", "ClusterSystem", globalIP, 2551)
  val address3 = Address("akka.tcp", "ClusterSystem", globalIP, 2551)
  val address4 = Address("akka.tcp", "ClusterSystem", globalIP, 2551)
  val address5 = Address("akka.tcp", "ClusterSystem", "18.219.222.126", 8000)
  val address6 = Address("akka.tcp", "ClusterSystem", "18.191.32.227", 8000)
  val address7 = Address("akka.tcp", "ClusterSystem", "18.222.213.215", 8000)
  val address8 = Address("akka.tcp", "ClusterSystem", "18.220.113.146", 8000)
  val address9 = Address("akka.tcp", "ClusterSystem", "18.191.167.41", 8000)
  val address10 = Address("akka.tcp", "ClusterSystem", "18.216.128.105", 8000)
  val address11 = Address("akka.tcp", "ClusterSystem", "18.222.129.85", 8000)
  val address12 = Address("akka.tcp", "ClusterSystem", "18.216.77.186", 8000)
  val address13 = Address("akka.tcp", "ClusterSystem", "18.222.250.169", 8000)
  val address14 = Address("akka.tcp", "ClusterSystem", "13.58.46.116", 8000)
  val address15 = Address("akka.tcp", "ClusterSystem", "13.59.86.243", 8000)
