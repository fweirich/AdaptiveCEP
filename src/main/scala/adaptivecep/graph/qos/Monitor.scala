...
case class LeafNodeData(name: String, requirements: Set[Requirement], context: ActorContext)
case class UnaryNodeData(name: String, requirements: Set[Requirement], context: ActorContext, childNode: ActorRef)
case class BinaryNodeData(name: String, requirements: Set[Requirement], context: ActorContext, childNode1: ActorRef, childNode2: ActorRef)
